...
- **Module Scripts (injected in sequence)**:
  ...
  - [favorites.js](file:///Users/leo/🔥Projects/chrome-plugins/chat-toc/favorites.js): Manages persistent favorite prompts (CRUD modal dialogs, list rendering with sort selectors, and input autocomplete popup).
